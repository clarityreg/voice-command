...
export const THEME_METADATA = {
  ...
  'colorblind-friendly': {
    name: 'colorblind-friendly' as ThemeName,
    displayName: 'Colorblind Friendly',
    description: 'Optimized palette for color vision deficiency',
  ...
  'midnight-purple': {
    name: 'midnight-purple' as ThemeName,
    displayName: 'Midnight Purple',
    description: 'Deep purple theme with violet accents',
  ...
  'sunset-orange': {
    ...
    description: 'Warm sunset tones with orange and coral',
    cssClass: 'theme-sunset-orange',
    category: 'warm',
    accessibility: 'standard',
  },
  'mint-fresh': {
    name: 'mint-fresh' as ThemeName,
    displayName: 'Mint Fresh',
    description: 'Light minty green theme with fresh tones',
